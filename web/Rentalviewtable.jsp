<%-- 
    Document   : Rentalviewtable
    Created on : Apr 4, 2024, 3:34:52 PM
    Author     : hp
--%>
    ...
    <body>
     ...
     <li class="active"> <a href="home2.jsp"><i class='bx bxs-home'></i> Home</a> </li> 
      ...
      <li>  <a href="Job.jsp">Jobs</a></li>
        ...
        <center>
        <h1 target="blank">  Rental  Details</h1>
...
<th>House_No</th>
<th>Owners_Name</th>
<th>Facilities_of_House</th>
<th>Address</th>
<th>Location</th>
<th>Rent</th>
<th>Rent_in_Advance</th>
<th>City</th>
<th>Contact</th>
<th>update</th>
<th>delete</th>
...
try{
    ...
    ResultSet rs=st.executeQuery("select *from rental where Location='"+s+"'");
    //if(name.equals("admin") & pass.equals("admin"))
        while(rs.next())
         {
 int id=rs.getInt("uid");
String a=rs.getString("House_No"); 
String b=rs.getString("Owners_Name");
String c=rs.getString("Facilities_of_House");
String d=rs.getString("Address");
String e=rs.getString("Location");
String f=rs.getString("Rent");
String g=rs.getString("Rent_in_Advance");
...
<td><%=h%></td>
<td><%=i%></td>
<td> <a href="rentalupdatetable.jsp?uid=<%=id%>&House_No=<%=a%>&Owners_Name=<%=b%>&Facilities_of_House=<%=c%>&Address=<%=d%>&Location=<%=e%>&Rent=<%=f%>&Rent_in_Advance=<%=g%>&City=<%=h%>&Contact=<%=i%>"> update <i class='bx bxs-edit-alt'></i></td>
<td><a href="Rentalviewtabledelete.jsp?uid=<%=id%>">delete <i class='bx bxs-trash-alt'></i></a></td>
</tr>
<%
}
}catch(Exception e)           
...
%><br>
         ...
         <div  class="button">
 <a href="Rentalresponse.jsp" class="btn">Back</a>
     </div>
    </body></center><br>
</html>