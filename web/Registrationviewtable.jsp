<%-- 
    Document   : Registrationviewtable
    Created on : Apr 4, 2024, 9:24:24 PM
    Author     : hp
--%>
...
<html>
 ...
 <center><h1> Registration View Details</h1>
       <table border="1">
<tr><br>
<th>uid</th>
<th>Username</th>
...
try{
    ...
    ResultSet rs=st.executeQuery("select *from user where uid='"+s+"'");
...
<td>update  <i class='bx bxs-edit-alt'></i></td>

<td><a href="Registrationviewtabledelete.jsp?uid=<%=id%>">delete  <i class='bx bxs-trash-alt'></i></a></td>
</tr>
<%
}
}catch(Exception e)           
...
%><br>
        ...
        <div  class="button">
 <a href="Registrationresponse.jsp" class="btn">Back</a>
     </div>
    </body><br></center>
</html>