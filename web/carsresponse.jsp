<%-- 
    Document   : carsresponse
    Created on : Apr 8, 2024, 3:05:05 PM
    Author     : hp
--%>
    ...
    <body> 
     ...
     <li class="active"> <a href="home2.jsp"><i class='bx bxs-home'></i> Home</a> </li> 
      ...
      <li>  <a href="Job.jsp">Jobs</a></li>
        ...
        <form action="Carsviewtable.jsp" method="post">
    <table>
        <center><h1 target="blank"> Enter Company Name</h1></center><br>
                <td>
                   <b> Company Name: </b></td><td>
