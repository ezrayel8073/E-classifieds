<%-- 
    Document   : collegeresponse
    Created on : Apr 8, 2024, 3:02:10 PM
    Author     : hp
--%>
     ...
     <li class="active"> <a href="home2.jsp"><i class='bx bxs-home'></i> Home</a> </li> 
      ...
      <li>  <a href="Job.jsp">Jobs</a></li>
       ...
       <center><div class="login-container">
        <form action="collegeviewtable.jsp" method="post">
   
        <h1 target="blank"> Enter College Name</h1>
         <table>
             <tr>
                <td>
                   <b> College Name:</b> </td><td>
