<%-- 
    Document   : courseresponse
    Created on : Apr 8, 2024, 3:02:44 PM
    Author     : hp
--%>
     ...
     <li class="active"> <a href="home2.jsp"><i class='bx bxs-home'></i> Home</a> </li> 
      ...
      <li>  <a href="Job.jsp">Jobs</a></li>
       ...
       <center><div class="login-container">
        <form action="courseviewtable.jsp" method="post">
    <table>
        <h1 target="blank"> Enter Course Name</h1><br><br>
                <td>
                    <b>Course Name : </b></td><td>
