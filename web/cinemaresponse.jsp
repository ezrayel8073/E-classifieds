<%-- 
    Document   : cinemaresponse
    Created on : Apr 8, 2024, 3:04:03 PM
    Author     : hp
--%>
...
<html>
    <head>
        ...
        <style>
         body{
                  background-image:url("image/cinema1");
                  height: 100vh;
...
<link href='https://unpkg.com/boxicons@2.1.4/css/boxicons.min.css' rel='stylesheet'>
    ...
    <body> 
     ...
     <center><div class="login-container">
        <form action="Cinemaviewtable.jsp" method="post">
    <table>
        <tr><h1 target="blank"> Enter Location</h1><br>
                <td>
                   <b>Location:</b> </td><td>
