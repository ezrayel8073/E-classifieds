<%-- 
    Document   : universityviewtable
    Created on : Apr 4, 2024, 3:31:22 PM
    Author     : hp
--%>
    ...
    <body>
     ...
     <li class="active"> <a href="home2.jsp"><i class='bx bxs-home'></i> Home</a> </li> 
      ...
      <li>  <a href="Job.jsp">Jobs</a></li>
        ...
        <center>
        <h1 target="blank">University Details</h1>
...
<td><%=f%></td>
<td><%=g%></td>
<td> <a href="universityupdatetable.jsp?uid=<%=id%>&University_Id=<%=a%>&Name=<%=b%>&Location=<%=c%>&Address=<%=d%>&Date=<%=e%>&About=<%=f%>&Web_Address=<%=g%>"> update <i class='bx bxs-edit-alt'></i></td>
<td><a href="universityviewtabledelete.jsp?uid=<%=id%>">delete <i class='bx bxs-trash-alt'></i></a></td>
</tr>
<%
}
}catch(Exception e)           
...
<br>
     ...
     <div  class="button">
 <a href="universityresponse.jsp" class="btn">Back</a>
     </div>
    </body></center><br>
</html>