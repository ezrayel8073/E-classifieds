<%-- 
    Document   : RentalModel
    Created on : Apr 2, 2024, 3:32:53 PM
    Author     : hp
--%>
...
<body>
    ...
    <center><div class="login-container">
        <form action="RentalModelbackend.jsp" method="post">
            <center>   <h1> Rental Details</h1><br>
            <table>
                <tr>
                <td>House no:</td><td>
    <input type="int" id="fname" name="House_No" required>
                </td></tr> 
                <tr>
                    <td>Owner's name: </td><td>
    <input type="text" id="lname" name="Owners_Name" required>
                    </td></tr>
                <tr>
                 <td>Facilities of house:</td><td>
    <input type="text" id="email" name="Facilities_of_House" required>
    </td></tr>  
                <tr>
    <td>Address:</td><td>
    <input type="text" id="phone" name="Address" required>
                ...
                <tr>
                    <td>Location:</td><td>
   <input type="text" id="phone" name="Location" required>
    </td></tr>
                <tr>
    <td>Rent:</td><td>
    <input type="int" id="password" name="Rent" required>
    </td></tr>
                <tr>
                    <td>Rent in advance:</td><td>
                   <input type="int" id="phone" name="Rent_in_Advance" required>
                        </td></tr>
                 <tr>
             <td>
         <label for="name">city:</label>&emsp;&emsp;
         </td>
         <td>
