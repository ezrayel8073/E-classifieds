<%-- 
    Document   : universityresponse1
    Created on : Apr 8, 2024, 7:22:15 PM
    Author     : hp
--%>
...
button:hover {
 ...
 <link href='https://unpkg.com/boxicons@2.1.4/css/boxicons.min.css' rel='stylesheet'>
   ...
   <center><div class="login-container">
        <form action="viewuniversity1.jsp" method="post">
    <table>
        <center><h4 target="blank"> Enter University Name</h4></center>
                <td>
