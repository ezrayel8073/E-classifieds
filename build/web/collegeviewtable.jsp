<%-- 
    Document   : collegeviewtable
    Created on : Apr 4, 2024, 3:32:09 PM
    Author     : hp
--%>
    ...
    <body>
     ...
     <li class="active"> <a href="home2.jsp"><i class='bx bxs-home'></i> Home</a> </li> 
      ...
      <li>  <a href="Job.jsp">Jobs</a></li>
        ...
        <center>
        <h1 target="blank">College Details</h1>
...
try{
    ...
    ResultSet rs=st.executeQuery("select *from college where Name='"+s+"'");
    //if(name.equals("admin") & pass.equals("admin"))
        while(rs.next())
         {
 int id=rs.getInt("uid");
String a=rs.getString("University");
String b=rs.getString("College_Id");
String c=rs.getString("Name");
String d=rs.getString("Address");
String e=rs.getString("Location");
String f=rs.getString("Web_Address");
String g=rs.getString("About");
...
<td><%=g%></td>
<td><%=h%></td>
<td> <a href="collegeupdatetable.jsp?uid=<%=id%>&University=<%=a%>&College_Id=<%=b%>&Name=<%=c%>&Address=<%=d%>&Location=<%=e%>&Web_Address=<%=f%>&About=<%=g%>&Date=<%=h%>"> update <i class='bx bxs-edit-alt'></i></td>
<td><a href="collegeviewtabledelete.jsp?uid=<%=id%>">delete <i class='bx bxs-trash-alt'></i></a></td>
</tr>
<%
}
}catch(Exception e)           
...
%><br>
       ...
       <div class="button">
  <a href="collegeresponse.jsp" class="btn">Back</a>
       </div>
    </body></center><br>
</html>