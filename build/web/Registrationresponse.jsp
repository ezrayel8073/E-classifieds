<%-- 
    ...
    Created on : Apr 8, 2024, 10:33:35 AM
    Author     : hp
--%>

<%-- 
    Document   : res
    Created on : Apr 6, 2024, 7:38:27 PM
    Author     : VAMSI
--%>
...
<html>
    <head>
        ...
        <style>
         body{
                  background-image:url("image/reg2");
                 height: 100vh;
    ...
    <body>
     ...
     <li class="active"> <a href="home2.jsp"><i class='bx bxs-home'></i> Home</a> </li> 
      ...
      <li>  <a href="Job.jsp">Jobs</a></li>
        ...
        <form action="Registrationviewtable.jsp" method="post">
    <table>
        <tr><h1> Enter User id</h1>
                <td>
                    User id: </td><td>
