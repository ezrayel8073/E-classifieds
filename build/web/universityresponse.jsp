<%-- 
    Document   : universityresponse
    Created on : Apr 8, 2024, 3:01:12 PM
    Author     : hp
--%>
...
button:hover {
 ...
 <link href='https://unpkg.com/boxicons@2.1.4/css/boxicons.min.css' rel='stylesheet'>
   ...
   <center><div class="login-container">
        <form action="universityviewtable.jsp" method="post">
    <table>
       <center> <h1 target="blank"> Enter University Name</h1></center><br>
                <td>
                  <b>  University Name: </b></td><td>
