<%-- 
    Document   : Cinemaviewtable
    Created on : Apr 4, 2024, 3:38:19 PM
    Author     : hp
--%>
...
<html>
    <head>
     ...
     <center>   <title> Cinema Halls Details </title>
         <style>
        body {
    ...
    <body>
     ...
     <li class="active"> <a href="home2.jsp"><i class='bx bxs-home'></i> Home</a> </li> 
      ...
      <li>  <a href="Job.jsp">Jobs</a></li>
        ...
        <center>
        <h1  target="blank">Cinema  Halls Details</h1>
...
<td> <a href="cinemaupdatetable.jsp?uid=<%=id%>&Theater_Name=<%=a%>&Movie_Name=<%=b%>&Duration_of_the_movie=<%=c%>&Price=<%=d%>&Location=<%=e%>&Parking_Availability=<%=f%>&City=<%=g%>&Contact=<%=h%>&Date=<%=i%>"> update <i class='bx bxs-edit-alt'></i></td>
<td><a href="Cinemaviewtabledelete.jsp?uid=<%=id%>">delete  <i class='bx bxs-trash-alt'></i></a></td>
</tr>
<%
}
}catch(Exception e)           
...
%><br>
  ...
  <div  class="button">
 <a href="cinemaresponse.jsp" class="btn">Back</a>
     </div>
    </body></center><br>
</html>